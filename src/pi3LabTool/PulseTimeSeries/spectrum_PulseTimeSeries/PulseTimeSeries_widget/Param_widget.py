...
class ParamPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        self.ed_device = QLineEdit("spcm0")
        self.ed_clk    = QLineEdit("---")
        self.ed_ch     = QLineEdit("1")
        self.ed_range  = QLineEdit("5000")
        self.ed_extclk = QLineEdit("---")

        self.spin_rate = QSpinBox(); self.spin_rate.setRange(1, 250_000_000); self.spin_rate.setValue(2_000)
        ...
        layout.addRow("adc_voltage_range (mV)", self.ed_range)
